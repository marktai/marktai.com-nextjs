...
const Header = ({
  ...
  return (
    <div className="h-[124px]">
      <header
        className={clsx(
          'fixed top-0 z-20 flex h-[80px] w-full items-center justify-between rounded-b-[20px] border-b-1 p-10 md:h-[124px]',
      ...
      {children ? (
        <div className="fixed top-[80px] right-0 z-20 h-[calc(100vh-80px)] md:top-[124px] md:h-[calc(100vh-124px)]">
          {children}
        </div>
      ) : null}
    </div>
